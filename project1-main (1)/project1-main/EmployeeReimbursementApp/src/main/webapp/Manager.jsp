...
<body>
	...
	<div class="right" style="background-color:tomato;">
    <h1><b>Employee Reimbursement System</b></h1>
    <frameset cols="25%,*,24%">
      <frame>
        <section>
          <center><img src='https://media.istockphoto.com/photos/quality-control-certification-checked-guarantee-of-standard-picture-id1061357372' height='800' width='800'></center>
        </section>
      </frame>
    </frameset>
  </div>
